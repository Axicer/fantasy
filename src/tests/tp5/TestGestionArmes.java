...
import protagoniste.GroupeHommes;
...
public class TestGestionArmes {
	...
	public static void main(String[] args) {
		...
		//TODO il manque Alain dans le resultat et le combat contre Aqualave renvoi rien
		...
		System.out.println("arc2 tire sa seule fleche est n'est plus operationnel");
		arc2.utiliser();
		System.out.println("arc1 = arc2 ? " + arc1.isSameAs(arc2));
